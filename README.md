# Cloud Kitchen Data Analytics

End-to-end data analytics project on a cloud kitchen business using Excel, SQL, and Power BI — covering data cleaning, analysis, and dashboard reporting to uncover business insights around customers, menu performance, and orders.

## 📊 Dashboard Preview

![Power BI Dashboard](https://github.com/user-attachments/assets/f141eaf9-702d-4464-9fad-a58fbb12e2e3)

![Power BI Dashboard 2](https://github.com/user-attachments/assets/46b146a7-9398-433b-9679-add98f8d8cb3)
...
| [📝 SQL_Queries_CloudKitchen.docx](SQL_Queries_CloudKitchen.docx) | Word document containing 20 SQL queries written for data verification and business analysis |
...
- Evening hours see the highest order volume, consistent with the snack-focused menu.
